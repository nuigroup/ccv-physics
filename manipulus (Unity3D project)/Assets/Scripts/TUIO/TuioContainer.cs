...
public abstract class TuioContainer:TuioPoint {
	...
	/**
	 * A Vector of TuioPoints containing the contour of the TUIO object
	 */
	private List<TuioPoint> contour;
	/**
	 * vars for heightmap
	 */
	private int width;	
	...
	private float hxPos;
	private float hyPos;
	private List<float> heightPoints;
	/**
	...
	/**
	 * Returns the contour of this TuioContainer.
	 * @return	the contour of this TuioContainer
	 */
	public List<TuioPoint> getContour() {
		return contour;
	}
	...
	public float getHXpos() {
		return hxPos;
	}
		
	public float getHYpos() {
		return hyPos;
	}	
